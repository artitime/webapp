      ...
      <Fade in={open} timeout={700}>
        ...
        >
          <Paper elevation={9} sx={{ borderRadius: 1, overflow: 'hidden' }}>
            <a target='_blank'
              rel='noreferrer'
              href='https://vartikatiwari.com/'><img width='100%' alt='materio-pro-banner' src='/images/misc/materio-pro-banner.png' />
              </a>
            <CardContent>
              ...
              <Typography sx={{ mb: 4 }} variant='body2'>
                Click on below buttons to explore .
              </Typography>
              <Button
                component='a'
                sx={{ mr: 4 }}
                target='_blank'
                variant='contained'
                href='https://vartikatiwari.com/landing/'
              >
                Demo
              </Button>
